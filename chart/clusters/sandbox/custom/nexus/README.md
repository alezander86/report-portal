...
| nexus-repository-manager.ingress.hostRepo | string | `"nexus-ci.eks-sandbox.aws.main.edp.projects.epam.com"` |  |
...
| oauth2-proxy.ingress.hosts[0] | string | `"nexus.eks-sandbox.aws.main.edp.projects.epam.com"` |  |

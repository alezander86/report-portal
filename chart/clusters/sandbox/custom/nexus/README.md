...
| nexus-repository-manager.ingress.hostRepo | string | `"nexus2-ci.eks-sandbox.aws.main.edp.projects.epam.com"` |  |
...
| oauth2-proxy.ingress.hosts[0] | string | `"nexus2.eks-sandbox.aws.main.edp.projects.epam.com"` |  |

...
|-----|------|---------|-------------|
| job.clusterApiUrl | string | `"https://api.okd-sandbox.aws.main.edp.projects.epam.com:6443"` |  |
| job.keycloakUrl | string | `"https://keycloak.eks-core.aws.main.edp.projects.epam.com/auth/realms/okd-sandbox"` |  |
...
| vault.server.route.host | string | `"vault.apps.okd-sandbox.aws.main.edp.projects.epam.com"` |  |

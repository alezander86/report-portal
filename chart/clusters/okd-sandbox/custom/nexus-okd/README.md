...
| nexus-repository-manager.deployment.initContainers[0].securityContext.runAsUser | int | `1000700000` |  |
...
| nexus-repository-manager.ingress.hostRepo | string | `"nexus.apps.okd-sandbox.aws.main.edp.projects.epam.con"` |  |
...
| nexus-repository-manager.nexus.securityContext.fsGroup | int | `1000700000` |  |
| nexus-repository-manager.nexus.securityContext.runAsUser | int | `1000700000` |  |
...
| oauth2-proxy.securityContext.runAsUser | int | `1000700001` |  |
